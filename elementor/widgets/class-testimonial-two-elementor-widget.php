...
namespace Elementor;
class Edus_Testimonial_Two_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'edus-testimonial-two-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Testimonial: 02', 'edus-master' );
	}
	...
	protected function _register_controls() {
		...
		$repeater->add_control( 'title',
			[
				...
				'default'     => esc_html__( 'See the E Learning Tools your comp titers - ', 'edus-master' )
			] );
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .single-testimonial-item-02 .thumb' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .single-testimonial-item-02 .thumb img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section( 'icon_styling_section', [
			'label' => esc_html__( 'Icon Styling Settings', 'edus-master' ),
			'tab'   => Controls_Manager::TAB_STYLE
		] );
		$this->add_control( 'icon_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-02 .icon" => "-webkit-text-stroke-color: {{VALUE}}"
			]
		] );
		$this->end_controls_section();
		...
		$this->add_group_control( Group_Control_Background::get_type(), [
			...
			'selector' => "{{WRAPPER}} .single-testimonial-item-02 .content"
		] );
		$this->add_control(
			'content_padding',
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .single-testimonial-item-02 .content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .single-testimonial-item-02 .content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					"{{WRAPPER}} .single-testimonial-item-02 .content p" => 'margin-top: {{SIZE}}{{UNIT}};'
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					"{{WRAPPER}} .single-testimonial-item-02 .content .ratings i+i" => 'margin-left: {{SIZE}}{{UNIT}};'
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					"{{WRAPPER}} .single-testimonial-item-02 .content .author-meta" => 'margin-top: {{SIZE}}{{UNIT}};'
				]
			]
		);
		$this->add_control( 'name_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-02 .content .author-meta .title" => "color: {{VALUE}}"
			]
		] );
		...
		$this->add_control( 'description_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-02 .content .description" => "color: {{VALUE}}"
			]
		] );
		$this->add_control( 'designation_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-02 .content .author-meta .designation" => "color: {{VALUE}}"
			]
		] );
		$this->add_control( 'rating_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-02 .content .ratings" => "color: {{VALUE}}"
			]
		] );
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			...
			"selector" => "{{WRAPPER}} .single-testimonial-item-02 .content .author-meta .title"
		] );
		$this->add_group_control( Group_Control_Typography::get_type(), [
			'name'     => 'description_typography',
			'label'    => esc_html__( 'Description Typography', 'edus-master' ),
			"selector" => "{{WRAPPER}} .single-testimonial-item-02 .content p"
		] );
		$this->add_group_control( Group_Control_Typography::get_type(), [
			'name'     => 'designation_typography',
			'label'    => esc_html__( 'Designation Typography', 'edus-master' ),
			"selector" => "{{WRAPPER}} .single-testimonial-item-02 .content .author-meta .designation"
		] );
		$this->end_controls_section();
	}
				...
				foreach ( $all_testimonial_items as $item ):
                    ...
                    <div class="ts-outer-wrap">
                        <div class="single-testimonial-item-02">
                            <div class="content">
                            <div class="icon">
								<?php echo edus_master()->render_elementor_icons( $item['icon'] ) ?>
                            </div>
                                <h3 class="title">
									<?php
									$title = str_replace( [ '{c}', '{/c}' ], [ '<span>', '</span>' ], $item['title'] );
...
Plugin::instance()->widgets_manager->register_widget_type( new Edus_Testimonial_Two_Widget() );
