...
namespace Elementor;
class EdusEdus_course_Slider_Three_Widget extends Widget_Base
{
    ...
    {
        return 'edus-course-slider-three-widget';
    }
    ...
    {
        return esc_html__('Course Item 03', 'edus-master');
    }
    ...
    protected function render()
    {
        ...
        <div class="course-single-item-wrap">
            ...
            while ($post_data->have_posts()):$post_data->the_post();
                ...
                ?>
                <div class="course-single-item style-01 margin-bottom-30">
                    <div class="thumb">
                    ...
                    <div class="content">
                        ...
                        <div class="tutor-course-loop-meta">
                            ...
                            <div class="tutor-single-loop-meta">
                                <i class='tutor-icon-user'></i><span><?php echo $course_students; ?></span> <?php echo esc_html('Student')?>
                            </div>
                            <?php
...
Plugin::instance()->widgets_manager->register_widget_type(new EdusEdus_course_Slider_Three_Widget());