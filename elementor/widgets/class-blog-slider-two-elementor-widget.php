...
namespace Elementor;
class Edus_Blog_Post_Slider_Two_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Blog: Slider 02', 'edus-master' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control( 'normal_post_paragraph_color', [
			...
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
				"{{WRAPPER}} .single-blog-grid-02 .content .post-categories li" => "color: {{VALUE}}"
			]
		] );
		$this->add_control( 'normal_background_color', [
			...
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
				"{{WRAPPER}} .single-blog-grid-02 .content" => "background-color: {{VALUE}}"
			]
		] );
		$this->add_control( 'normal_post_border_color', [
			...
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
				"{{WRAPPER}} .single-blog-grid-02 .content" => "border-color: {{VALUE}}"
			]
		] );
		...
		$this->add_control( 'normal_hover_background_color', [
			...
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
				"{{WRAPPER}} .single-blog-grid-02:hover .content" => "background-color: {{VALUE}}"
			]
		] );
		$this->add_control( 'normal_post_hover_border_color', [
			...
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
				"{{WRAPPER}} .single-blog-grid-02:hover .content" => "border-color: {{VALUE}}"
			]
		] );
		$this->end_controls_tab();
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			...
			'selector'    => "{{WRAPPER}} .single-blog-grid-02 .content .post-categories li"
		] );
		$this->end_controls_section();
...
Plugin::instance()->widgets_manager->register_widget_type( new Edus_Blog_Post_Slider_Two_Widget() );