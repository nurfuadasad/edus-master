...
namespace Elementor;
class EdusEdus_course_Slider_Two_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'edus-course-slider-two-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Course Item 02', 'edus-master' );
	}
                ...
                <div class="row">
					...
					while ( $post_data->have_posts() ):$post_data->the_post();
                        ...
                        <div class="col-lg-<?php echo esc_attr( $settings['column'] ); ?> col-md-6">
                            <div class="course-single-item-02 margin-bottom-30">
                                <div class="thumb">
...
Plugin::instance()->widgets_manager->register_widget_type( new EdusEdus_course_Slider_Two_Widget() );