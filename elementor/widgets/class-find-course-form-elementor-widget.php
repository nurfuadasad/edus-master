...
class Edus_Find_Course_Widget extends Widget_Base
{
    ...
    public function get_name()
    {
        ...
        return 'edus-find-course-widget';
    ...
    public function get_title()
    {
        ...
        return esc_html__('Find Course From: 01', 'edus-master');
    ...
    protected function render()
    {
        ...
        <form class="dream-course-form" action="<?php echo esc_url(home_url('/')) ?>" method="get">
            <div class="dream-course-search">
                ...
                <div class="dream-course-category">
                    <select class="nice-select" name="course-category">
                        <?php
                        foreach ($all_terms as $term) {
                            printf('<option value="%1$s" class="option">%1$s</option>', esc_attr($term->name));
                        };
                        ?>
                    </select>
                </div>
...
Plugin::instance()->widgets_manager->register_widget_type(new Edus_Find_Course_Widget());