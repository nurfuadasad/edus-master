...
if ( ! function_exists( 'cs_get_option' ) ) {
	function cs_get_option( $option = '', $default = null ) {
		$options = get_option( 'edus_theme_options' ); // Attention: Set your unique id of the framework
...
if ( ! function_exists( 'cs_get_customize_option' ) && class_exists( 'CSF' )) {
	...
	function cs_get_customize_option( $option = '', $default = null ) {
		$options = get_option( 'edus_customize_options' ); // Attention: Set your unique id of the framework
		return ( isset( $options[$option] ) ) ? $options[$option] : $default;
	}
}
