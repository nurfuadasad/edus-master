...
class Edus_Contact_Info_Widget extends WP_Widget
{
    ...
    public function __construct()
    {
        parent::__construct(
            'edus_contact_info',
            esc_html__('Edus: Contact Info', 'edus-master'),
            array('description' => esc_html__('Display contact info widget', 'edus-master'))
        );
    }
    ...
    public function form($instance)
    {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id($ci)); ?>"><?php echo esc_html(ucfirst($ci) . " " . esc_html__('Info', 'edus-master')); ?>
                : </label>
            <br/>
            ...
            <small><?php echo esc_html__('Leave it blank if you don\'t want to show this info', 'edus-master') ?></small>
        </p>
...
if (!function_exists('Edus_Contact_Info_Widget')) {
    function Edus_Contact_Info_Widget()
    {
        register_widget('Edus_Contact_Info_Widget');
    }

    add_action('widgets_init', 'Edus_Contact_Info_Widget');
}
